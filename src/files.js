...
const FilesPagination = props => <Pagination rowsPerPageOptions={[10, 25, 50, 100]} {...props} />;
/**
 *
            ...
            <div style={{width: '100%'}}>
                <Box display="flex" flexDirection="row" p={1} m={1} bgcolor="background.paper">
                    <Box width="40%" bgcolor="white.300">
                        ...
                        <ImageInput multiple={false} source="pictures" label="Related picture" accept="image/*">
